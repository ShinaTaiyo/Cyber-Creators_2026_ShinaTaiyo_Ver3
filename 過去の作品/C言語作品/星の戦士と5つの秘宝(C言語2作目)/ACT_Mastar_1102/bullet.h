...
BULLETTYPE_SEED,//種弾
BULLETTYPE_SNOW,//雪弾
BULLETTYPE_ICICLE,//つらら弾
BULLETTYPE_SPLET,//スプレッド弾
BULLETTYPE_JUMPING,//ジャンプ弾
BULLETTYPE_EXPLOSION,//爆発弾
BULLETTYPE_FINALBALL,//ラスボスの必殺技の弾
BULLETTYPE_MAX
}BULLETTYPE;
...
typedef struct
{
	...
	bool bCollisionBullet;//弾がブロックに衝突するかどうかのフラグ
