...
void SetMode(MODE mode)
{
	...
	case MODE_TITLE://タイトル画面
		InitTitle();
		InitStaging();
		SetStaging(STAGINGTYPE_PRESSSTART, -1, D3DXVECTOR3(SCREEN_WIDTH - 200.0f, SCREEN_HEIGHT - 200.0f, 0.0f), 10000, ATTACKTYPE_PUNCH, -1, -1, 0, -1, -1, -1);
		InitFade();
		break;
	case MODE_TUTORIAL:
		/*InitEffect();
