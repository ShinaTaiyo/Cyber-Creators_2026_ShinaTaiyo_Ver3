...
#define COMMAND_SIZE_X (100.0f)
#define COMMAND_SIZE_Y (50.0f)
...
void InitPause(void)
{
	...
	D3DXCreateTextureFromFile(pDevice,
		"data\\TEXTURE\\Pause_And_Tutorial.png",
		&g_pTexturePause[0]);

	D3DXCreateTextureFromFile(pDevice,
		"data\\TEXTURE\\CONTINE_indicate.png",
		&g_pTexturePause[1]);


	D3DXCreateTextureFromFile(pDevice,
		"data\\TEXTURE\\RETRY_indicate.png",
		&g_pTexturePause[2]);


	D3DXCreateTextureFromFile(pDevice,
		"data\\TEXTURE\\QUIT_indicate.png",
		&g_pTexturePause[3]);
	...
	for (nCntPause = 1; nCntPause < MAX_PAUSE_TEX; nCntPause++)
	{
		...
		g_aPause[nCntPause].pos = D3DXVECTOR3(SCREEN_WIDTH / 2, 144.0f * nCntPause, 0.0f);//真ん中に三段オプションコマンドを用意する。
	}
	VERTEX_2D* pVtx;
